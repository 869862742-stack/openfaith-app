...
(String, Color) getReligionIconConfig(String name) {
  const map = <String, (String, Color)>{
    ...
    '玛雅宗教': ('pyramid', Color(0xFF70E000)),
    '玛雅 / 阿兹特克': ('pyramid', Color(0xFF70E000)),
    '阿兹特克宗教': ('pyramid', Color(0xFF70E000)),
    '基督教（新教）': ('cross', Color(0xFFFFD60A)),
    '基督教（东正教）': ('orthodox_cross', Color(0xFFFFD60A)),
    '伊斯兰教（逊尼派）': ('crescent', Color(0xFF00E5FF)),
    '伊斯兰教（什叶派）': ('crescent', Color(0xFF00E5FF)),
    '诺斯替宗教': ('snake', Color(0xFF9D4EDD)),
