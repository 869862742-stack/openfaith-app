  ...
  return Scaffold(
    ...
    body: Column(children: [
      ...
      Expanded(child: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        const SizedBox(height: 4),
        _buildSettingsCard(Icons.phone_android, '绑定手机', subtitle: '138****8888'),
        const SizedBox(height: 4),
        _buildSettingsCard(Icons.email_outlined, '绑定邮箱', subtitle: 'user@example.com'),
        const SizedBox(height: 4),
  ...
  return Scaffold(
    ...
    body: Column(children: [
      ...
      Expanded(child: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        const SizedBox(height: 24),
        _buildSettingsCard(Icons.volume_up, '铃声', subtitle: '柔和铃声'),
        const SizedBox(height: 4),
        _buildSettingsCard(Icons.vibration, '振动', subtitle: '开启'),
      ])),
    ]),
  );
}
...
Widget _buildSettingsLanguage() {
  final langs = [
    ['🇨🇳', '简体中文', 'Chinese Simplified', true],
    ['🇨🇳', '繁體中文', 'Chinese Traditional', false],
